...
import profile from '../../assets/1722056500481.jpg';
    ...
    return(
        ...
        <div className=" card mt-2 rounded-top-4 rounded-0 pb-3">
            <div className=" card-img  position-relative">
                <img src={banner} alt="" className=' rounded-top-4 w-100'  height={ 50}/>
            </div>
        <div className=' card-body p-0 mx-4'>
           <button className='card-profile bg-transparent rounded-circle border-0 position-absolute'>
            <img src={profile} className=' rounded-circle border border-white border-3' width={75}  alt="" />
           </button>
           <div className=' mt-4'>
