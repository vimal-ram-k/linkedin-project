...
export const NavigationBar = () => {
  return (
    <nav
      className=" navbar border-bottom p-0"
      id="navbarDropdown"
    >
      <ul className=" container-fluid d-flex justify-content-around align-content-center justify-content-md-center">
        ...
        <li className="btn nav-item">
          <Link to="/notifications">
            <i className="bi bi-bell-fill position-relative">
              ...
              <p className=" nav-item-name m-0 p-0 d-md-flex d-none">
                {' '}
                Notifications
              </p>
            </i>
        ...
        <li className="btn nav-item  d-flex flex-column d-none d-sm-flex ">
          ...
          <p className=" position-relative nav-item-name m-0 p-0 d-md-flex d-none">
            {' '}
            For Business{' '}
            <i
              className=" bi bi-caret-down-fill position-absolute top-0 start-100"
              style={{ fontSize: '0.7rem' }}
            ></i>
          </p>
        </li>
