import imagelogo from '../../assets/images/icons8-image-48.png';
  ...
  return (
    <div className=" py-2 border h-25 col-12 col-sm-6  col-lg-6 col-xl-4 rounded-2 mt-md-3">
      <section className=" d-flex align-items-center justify-content-center column-gap-2">
        ...
        ></i>
        <div
          className=" border rounded-5 position-relative"
          style={{ width: '80dvw', height: '50px' }}
        >
          <span className="post-placeholder position-absolute  ps-4 mt-2 text-nowrap ">
            Start a post, try writing with AI
          </span>
          <input
            type="text"
            className=" bg-transparent border-0  position-absolute start-0 ps-4 mt-2 text-nowrap "
            style={{ outline: 'none' }}
          />
        </div>
      </section>
